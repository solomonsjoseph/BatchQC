        ...
        mainPanel(
            tabsetPanel(
                ...
                tabPanel('Normalization',
                    ...
                    h5("edgeR calculates scale factors using a trimmed mean of M-values between each pair of samples and multiplies the scale factors with original library size to get normalized library size. Inputs should be normalized using edgeR normalization if choose to use edgeR method for differential expression. The original read counts should not be transformed in any way before inputing."),
