#' kBET rejection rate
#' @description This function runs the k-nearest neighbor batch effect test (kBET) to
...
#' @description adapted from kBET package (https://github.com/theislab/kBET).
#' Provides recursive bisection algorithm for an arbitrary function. It evaluates the 
#' function \code{foo} at the bounds and replaces one of the boundaries until a maximum 
#' is found or the interval becomes too small
#' 
...
#' @description This function generates a boxplot of observed and expected rejection rates
