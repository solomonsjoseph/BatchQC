...
ANOVA can be used for normal-distributed data, and limma can be used for all 
other data. Kruskal-Wallis test can be used as a nonparametric equivalent of 
one-way ANOVA. edgeR implemented in BatchQC uses glm quasi-likelihood F-tests to
